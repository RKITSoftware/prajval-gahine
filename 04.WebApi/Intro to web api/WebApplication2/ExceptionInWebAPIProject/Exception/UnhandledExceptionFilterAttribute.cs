...
namespace ExceptionInWebAPIProject.Exception
{
    /// <summary>
    ...
    public class UnhandledExceptionFilterAttribute : ExceptionFilterAttribute
    {
        ...
        /// </value>
        private static Func<System.Exception, HttpRequestMessage, HttpResponseMessage> DefaultHandler = (exception, request) =>
        {
            if (exception == null)
            {
                return null;
