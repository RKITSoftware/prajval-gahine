...
namespace DatabaseWithCrudWebApi.Contexts
{
    ...
    public class DBUSR01Context
    {
        ...
        public ResponseInfo InsertUSR01(USR01 objUSR01)
        {
        ...
        /// <returns>A ResponseInfo object indicating the result of the operation.</returns>
        public ResponseInfo UpdateUSR01(USR01 objUSR01)
        {
        ...
        public ResponseInfo SelectUSR01()
        {
            DataTable dtUSR01 = new DataTable();

            MySqlCommand cmd = new MySqlCommand("SELECT r01f02 AS r01102, r01f03 AS r01103 FROM usr01;", _connection);
        ...
        /// <returns>A ResponseInfo object containing the result of the operation.</returns>
        public ResponseInfo SelectUSR01(int userId)
        {
        ...
        /// <returns>A ResponseInfo object indicating the result of the operation.</returns>
        public ResponseInfo DeleteUSR01(int userId)
        {
