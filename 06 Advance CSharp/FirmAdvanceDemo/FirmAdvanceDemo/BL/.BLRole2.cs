...
namespace FirmAdvanceDemo.BL
{
    ...
    {
        public ResponseStatusInfo GetRoles()
        {
        ...
        public ResponseStatusInfo GetRole(int roleId)
        {
            using (IDbConnection db = _dbFactory.OpenDbConnection())
            {
                try
        ...
        public ResponseStatusInfo AddRole(RLE01 role)
        {
            using (IDbConnection db = _dbFactory.OpenDbConnection())
            {
                try
        ...
        public ResponseStatusInfo RemoveRole(int RoleId)
        {
            using (IDbConnection db = _dbFactory.OpenDbConnection())
            {
                try
