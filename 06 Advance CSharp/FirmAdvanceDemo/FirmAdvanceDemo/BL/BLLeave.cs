...
namespace FirmAdvanceDemo.BL
{
    ...
    /// </summary>
    public class BLLeave : BLResource<LVE02>
    {
        /// <summary>
        ...
        public ResponseStatusInfo AddLeave(LVE02 leave)
        {
            try
            {
                leave.e02f03 = DateTime.Now.Date;
                leave.e02f07 = LeaveStatus.Pending;
        ...
        public ResponseStatusInfo FetchLeaves(LeaveStatus leaveType)
        {
            using (IDbConnection db = _dbFactory.OpenDbConnection())
            {
                try
                {
                    ...
                    {
                        sqlExp.Where(l => l.e02f07 == LeaveStatus.Approved);
                    }
        ...
        public ResponseStatusInfo GetLeaveCountByEmployeeIdAnMonthYear(int EmployeeId, int month, int year)
        {
            try
            {
                using (IDbConnection db = _dbFactory.OpenDbConnection())
                {
                    ...
                    SqlExpression<LVE02> sqlExp = db.From<LVE02>()
                        .Where(l => l.e02f02 == EmployeeId && l.e02f07 == LeaveStatus.Approved)
        ...
        /// <param name="EmployeeId">Employee Id</param>
        /// <returns>ResponseStatusInfo instance containing list_of_leaves, null when an exception occurs</returns>
        public ResponseStatusInfo FetchLeaveByEmployeeId(int EmployeeId)
        {
            try
            {
                using (IDbConnection db = _dbFactory.OpenDbConnection())
        ...
        /// <param name="year">Leave Year</param>
        /// <returns>ResponseStatusInfo instance containing list_of_leaves, null when an exception occurs                                                                                                         </returns>
        public ResponseStatusInfo FetchLeaveByMonthYear(int month, int year)
        {
            try
            {
                using (IDbConnection db = _dbFactory.OpenDbConnection())
                {
                    ...
                    SqlExpression<LVE02> sqlExp = db.From<LVE02>().
                        Where(l => l.e02f07 == LeaveStatus.Approved)
                        .And(l => l.e02f04 >= MonthFirstDate && l.e02f04 <= MonthLastDate)
                        .Or(
                            "adddate(e01f04, INTERVAL (e01f05 - 1) DAY) >= {0} AND adddate(e01f04, INTERVAL (e01f05 - 1) DAY) <= {1}",
                            MonthFirstDate.ToString("yyyy-MM-dd"),
        ...
        /// <returns>ResponseStatusInfo instance containing list_of_leaves, null when an exception occurs</returns>
        public ResponseStatusInfo FetchDateLeaves(DateTime? date = null)
        {
        ...
        /// <returns></returns>
        public ResponseStatusInfo FetchLeaveByEmployeeIdAndMonthYear(int EmployeeId, int month, int year)
        {
            try
            {
                using (IDbConnection db = _dbFactory.OpenDbConnection())
                {
                    ...
                    SqlExpression<LVE02> sqlExp = db.From<LVE02>()
                        ...
                        .And(l => l.e02f07 == LeaveStatus.Approved)
                        .And(l => l.e02f04 >= MonthFirstDate && l.e02f04 <= MonthLastDate)
                        .Or(
                            "adddate(e01f04, INTERVAL (e01f05 - 1) DAY) >= {0} AND adddate(e01f04, INTERVAL (e01f05 - 1) DAY) <= {1}",
                            MonthFirstDate.ToString("yyyy-MM-dd"),
        ...
        /// <param name="EmployeeId">Employee Id</param>
        /// <returns>ResponseStatusInfo instance containing list_of_leaves, null when an exception occurs</returns>
        public ResponseStatusInfo FetchLeaveByEmployeeIdForCurrentMonth(int EmployeeId)
        {
            try
            {
                using (IDbConnection db = _dbFactory.OpenDbConnection())
        ...
        /// <returns>ResponseStatusInfo instance containing null</returns>
        public ResponseStatusInfo UpdateLeaveStatus(int LeaveId, LeaveStatus toChange)
        {
            try
            {
                using (IDbConnection db = _dbFactory.OpenDbConnection())
                {
                    ...
                    if (leave.e02f07 == LeaveStatus.Expired)
                    {
                        throw new Exception($"Leave with leave id: {LeaveId} expired cannot approve");
                    }
                    if (leave.e02f07 == LeaveStatus.Pending && leave.e02f04 < CurrentDate)
                    {
                        toChange = LeaveStatus.Expired;
                    }
                    db.Update<LVE02>(new { e01f07 = toChange }, l => l.Id == LeaveId);
                }
        ...
        /// </summary>
        /// <returns>ResponseStatusInfo instance containing null</returns>
        public ResponseStatusInfo UpdateLeavesToExpire()
        {
            try
            {
                // get leave date and check if it is >= today
                ...
                using (IDbConnection db = _dbFactory.OpenDbConnection())
                {
                    db.Update<LVE02>(new { e01f07 = LeaveStatus.Expired }, l => l.e02f07 == LeaveStatus.Pending && l.e02f04 < CurrentDate);
                }
