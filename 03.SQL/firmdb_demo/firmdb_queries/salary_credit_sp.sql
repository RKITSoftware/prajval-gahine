...
BEGIN
	...
	SELECT
		H01F01, CURDATE(), H01F02 * (SELECT N01F04 FROM PSN01 WHERE N01F01=(SELECT P01F06 FROM EMP01 WHERE P01F01=H01F01))/240, (SELECT P01F06 FROM EMP01 WHERE P01F01=H01F01)
    FROM
		EMP_MONTH_WH;
    ...
    TRUNCATE TABLE EMP_MONTH_WH;    
END $$



CALL SALARY_CREDIT22();